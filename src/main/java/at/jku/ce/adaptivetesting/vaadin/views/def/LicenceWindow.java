...
public class LicenceWindow extends Window {
	...
	public LicenceWindow() {
		...
		vLayout.addComponent(new HtmlLabel("Weiterentwickelt durch CE JKU (2014 - 2018)"));
		vLayout.addComponent(new HtmlLabel("Weiterentwickelt durch Peter Baumann, BSc (2018)"));
